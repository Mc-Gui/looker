# The name of this view in Looker is "Domains"
view: domains {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: information_schema.domains ;;
  ...
  dimension: domain_default {
    type: string
    sql: ${TABLE}.domain_default ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [scope_name, udt_name, collation_name, character_set_name, domain_name]
  }
}
